...
/** Small inline SVG icons (no icon library needed) — preserved from the original app. */
...
/** Product mock shown on the right of the hero. */
function HeroMock() {
  return (
      ...
      <div className="mock-window">
        ...
        <div className="mock-body">
          ...
          <div className="mock-col mock-chat">
            ...
            <div className="mock-bubble mock-question">What were the Q3 revenue highlights?</div>

            <div className="mock-bubble mock-answer">
              <p>
                Q3 revenue grew <strong>18%</strong> quarter-over-quarter, driven mainly by enterprise
                subscriptions.
              </p>
...
/**
 * Marketing landing page — preserved from the original app, with the
 * temporary view-switching replaced by react-router links.
 */
          ...
          <div className="container hero-inner">
            <div className="hero-copy">
              ...
              <p className="hero-subtitle">
                Upload your PDFs, reports, and notes, then ask questions in plain language. Every
                answer is grounded in your own content — with citations you can verify.
              </p>
        ...
        <section className="section features" id="features">
          <div className="container">
            <div className="section-head">
              ...
              <p>
                Purpose-built for understanding large collections of documents without reading
                every page.
              </p>
            </div>
            ...
            <div className="features-grid">
              <div className="feature-card">
                ...
                <h3>Ask Questions</h3>
                <p>
                  Ask in plain language and get instant answers from across all your uploaded
                  documents.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Responses are generated only from your content, with citations so you can verify
                  every claim.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <p>
                  Upload PDFs, Word documents, and text files — we parse and index them
                  automatically.
                </p>
              </div>
              ...
              <div className="feature-card">
                ...
                <h3>Secure Access</h3>
                <p>
                  Your account and documents are protected with authenticated, private workspaces.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="section cta" id="cta">
          <div className="container">
            <div className="cta-card">
              ...
              <p>Upload your first document and see grounded answers in seconds.</p>
              <div className="cta-actions">
                <Link to="/signup" className="btn btn-inverse btn-lg">
